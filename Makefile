CC = gcc
CFLAGS = -g2 -ggdb -I./headers -W -Wall -Wno-unused-parameter -Wno-unused-variable -std=c11 -pedantic
...
parent_objects = $(OUT_DIR)/parent.o $(OUT_DIR)/parents_utils.o $(OUT_DIR)/environ_utils.o
child_objects = $(OUT_DIR)/child.o $(OUT_DIR)/environ_utils.o
parent_prog = $(OUT_DIR)/parent
child_prog = $(OUT_DIR)/child
parent_args = variables.txt 
